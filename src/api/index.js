...
export const createComment = (postId, commentData) =>
  API.post(`/comment/${postId}/comments`, commentData);
export const updateComment = (postId, commentId, updatedCommentData) =>
  API.patch(`/comment/${postId}/comments/${commentId}`, updatedCommentData);
export const deleteComment = (postId, commentId) =>
  API.delete(`/comment/${postId}/comments/${commentId}`);
export const likeComment = (postId, commentId) =>
  API.post(`/comment/${postId}/comments/${commentId}/like`);
export const dislikeComment = (postId, commentId) =>
  API.post(`/comment/${postId}/comments/${commentId}/dislike`);
